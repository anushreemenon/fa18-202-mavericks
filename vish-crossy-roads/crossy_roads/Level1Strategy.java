...
public class Level1Strategy extends Actor implements LevelStrategy {
    ...
    public void loadTerrains() {      
	  ...
	  // A. Land terrain:
        ...
        l1.getImage().scale(2400,200);
		l.getImage().scale(2400,100);
		...
		// 9. Add all objects to MyWorld at appropriate coordinates
	  ...
	  // C. Road terrain:
        ...
        rd1.getImage().scale(2400,100);
        rd2.getImage().scale(2400,100);
        rd3.getImage().scale(2400,100);
