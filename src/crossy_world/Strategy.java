 ...
 */
public class Strategy extends Actor implements LevelStrategy {
    protected int targetTimer=0;
    protected  boolean isFinishLevelReached = false;
    protected int carSpeed = 3;
    protected int logSpeed = 2;
